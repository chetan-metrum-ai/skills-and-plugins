...
description: Use this skill to record durable, non-secret OPSBOARD project status
  in git-bug and Git. Trigger when an agent starts, hands off, becomes blocked, requests
