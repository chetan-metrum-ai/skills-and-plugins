...
description: Use this skill to prepare a Git-native project for a hosted read-only
  OPSBOARD dashboard. Trigger when declaring a repository, Git ref, dashboard metadata,
  demo references, or a revocable read-only remote credential reference without granting
