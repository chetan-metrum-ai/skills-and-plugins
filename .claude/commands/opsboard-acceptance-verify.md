...
This command delegates to the agent skill at `../skills/opsboard-acceptance-verify/`.

## Skill Location

- **Path:** `../skills/opsboard-acceptance-verify/`
- **Manifest:** `../skills/opsboard-acceptance-verify/SKILL.md`
