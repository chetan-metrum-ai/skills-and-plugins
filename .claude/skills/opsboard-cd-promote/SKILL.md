...
description: Use this skill to prepare and execute an approval-gated promotion of
  a tested OPSBOARD project revision to its declared live-demo Kubernetes environment.
  Trigger when defining CD, selecting a project namespace, preparing a canary or rollback
