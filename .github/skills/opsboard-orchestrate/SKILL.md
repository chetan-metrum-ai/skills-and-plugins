...
description: Coordinate Git-native OPSBOARD worktrees and human decision gates. Use
  when agents are blocked on human input, when an operator must list waiting worktrees,
  when reviewing open decision issues, or when resuming work after a git-bug approval.
metadata:
  oasr:
    hash: sha256:5f467503bfb669ee153de4d720aa082c51ae40a9fa50f6b4d5423c6fff69a92c
