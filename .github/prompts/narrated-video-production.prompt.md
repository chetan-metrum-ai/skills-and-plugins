...
This prompt delegates to the agent skill at `../skills/narrated-video-production/`.

## Skill Location

- **Path:** `../skills/narrated-video-production/`
- **Manifest:** `../skills/narrated-video-production/SKILL.md`

## Usage

Invoke this skill by typing `/narrated-video-production` in the Copilot chat.
