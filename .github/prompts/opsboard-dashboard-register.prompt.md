...
This prompt delegates to the agent skill at `../skills/opsboard-dashboard-register/`.

## Skill Location

- **Path:** `../skills/opsboard-dashboard-register/`
- **Manifest:** `../skills/opsboard-dashboard-register/SKILL.md`

## Usage

Invoke this skill by typing `/opsboard-dashboard-register` in the Copilot chat.
