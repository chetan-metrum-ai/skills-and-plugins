...
This prompt delegates to the agent skill at `../skills/opsboard-orchestrate/`.

## Skill Location

- **Path:** `../skills/opsboard-orchestrate/`
- **Manifest:** `../skills/opsboard-orchestrate/SKILL.md`

## Usage

Invoke this skill by typing `/opsboard-orchestrate` in the Copilot chat.
