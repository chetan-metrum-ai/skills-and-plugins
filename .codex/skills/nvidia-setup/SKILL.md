...
description: Use this skill when installing or repairing NVIDIA GPU drivers, CUDA,
  Fabric Manager, or Docker GPU runtime on Ubuntu Linux servers. Trigger when the
  user asks to set up a GPU host, clean up an old NVIDIA stack, prepare a server for
  CUDA or vLLM workloads, or validate that containers can see GPUs.
metadata:
  oasr:
    hash: sha256:d6f0608dd57e4c971e6b7809c64dd9d0263e5c847835216eff0b3193d887d0cb
